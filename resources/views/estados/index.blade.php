    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <h4>Estado de Procesos</h4>
                </div>

                <div>
                    <!-- Contenido derecho -->
                    <a href="{{ route('estados.create') }}" class="btn btn-outline-primary btn-sm" title="Nuevo Estado">
                                       ...
                                       <td class="text-center">
                                            <div class="d-inline-flex align-items-center" style="gap: 2px;"> 
                                                ...
                                                <form action="{{ route('estados.destroy', $estado) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-sm btn-outline-danger" title="Eliminar" onclick="return confirm('¿Está seguro de eliminar este Estado?')">
