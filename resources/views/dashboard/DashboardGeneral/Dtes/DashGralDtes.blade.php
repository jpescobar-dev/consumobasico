            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3>Dashboard Documentos Tributarios General</h3>
                    </div>
                    <div class="dropdown filter custom-dropdown-icon">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="filterDropdown">
                            <a class="dropdown-item" data-value="<span>Show</span> : Daily Analytics" href="javascript:void(0);">Hoy</a>
                            <a class="dropdown-item" data-value="<span>Show</span> : Weekly Analytics" href="javascript:void(0);">Semana</a>
                            <a class="dropdown-item" data-value="<span>Show</span> : Monthly Analytics" href="javascript:void(0);">Mes</a>
                            <a class="dropdown-item" data-value="Download All" href="javascript:void(0);">Todos</a>
