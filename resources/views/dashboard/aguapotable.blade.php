...
@section('title', 'Dashboard_AguaPotable')
        ...
        <div class="layout-px-spacing">
            ...
            <div class="page-header">
                <div class="page-title">
                    <h3>Dashboard Consumo Agua Potable</h3>
                </div>
            </div>
            ...
            <div class="row mt-4">
                <div class="col-xl-12">
                    <div class="widget widget-table-one">
                        <h5 class="mt-3 ml-3">Consumo Agua Potable</h5>
                        <table id="dtes-table-aguapotable" class="table table-hover table-striped" style="width:100%">
                            <thead>
                                <tr>
...
<script>
    ...
    $(document).ready(function() {
        $('#dtes-table-aguapotable').DataTable({
            "oLanguage": {
                "oPaginate": { 
                    "sPrevious": "<", 
                    "sNext": ">" 
