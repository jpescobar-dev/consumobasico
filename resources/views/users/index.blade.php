...
@section('header_actions')
    <a href="{{ route('users.create') }}" class="btn btn-outline-primary btn-sm" title="Nuevo Usuario">
            ...
            <tbody>
                @foreach ($users as $user)
                    <tr>
                        ...
                        <form action="{{ route('users.destroy', $user) }}" method="POST" class="d-inline" onsubmit="return confirm('¿Está seguro de eliminar esta licitación?');">
                            @csrf
                            @method('DELETE')
